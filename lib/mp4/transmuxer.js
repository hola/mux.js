...
Transmuxer = function(options) {
  ...
  this.setupTsPipeline = function() {
    ...
    else
    {
      ...
      this.seek = function(pos, ss, opt){
        return pipeline.elementaryStream.seek(pos, ss, opt); };
      this.get_tl = function(id){
        return pipeline.elementaryStream.get_tl(id); };
      this.get_buf_pos = function(){
        return pipeline.elementaryStream.get_buf_pos(); };
    ...
    pipeline.elementaryStream.on('header_found',
          this.trigger.bind(this, 'header_found'));
    if (options.input_type==='mp4')
    {
